...
!function(t) {
    ...
    t.material = {
        options: {
            ...
            togglebuttonElements: ".togglebutton.langOpt > label > input[type=checkbox]",
        ...
        togglebutton: function(o) {
            var i = t(o ? o : this.options.togglebuttonElements).filter(":notmdproc").data("mdproc", !0).after("<span class='toggle'>VI<span>EN</span></span>");
            n(i)
        },
        radio: function(o) {
