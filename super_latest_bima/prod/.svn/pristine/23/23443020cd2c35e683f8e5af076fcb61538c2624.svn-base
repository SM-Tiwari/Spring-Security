...
<img src="http://103.129.188.37/assets/img/logo-bima.png" alt="Bima">
  ...
  <h1 class="display-3">Xác thực thành công!</h1>
  <p class="lead"><strong>Vui lòng kiểm tra thư điện tử </strong> của bạn để hoàn thành đăng ký tài khoản theo hướng dẫn.</p>
  <hr>
...
<div class="jumbotron text-xs-center" style="height:800px;">
  <h1 class="display-3">Rất tiếc vấn đề trong xác minh email!</h1>
