 ...
 */
            ...
            /**
            *  AttribDtl_type0 bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class AttribDtl_type0
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":AttribDtl_type0",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "AttribDtl_type0",
    ...
    public static class Factory{
        private static org.apache.commons.logging.Log log = org.apache.commons.logging.LogFactory.getLog(Factory.class);
                ...
                public static AttribDtl_type0 fromString(javax.xml.stream.XMLStreamReader xmlStreamReader,
                                                                    java.lang.String content) {
                    if (content.indexOf(":") > -1){
                        java.lang.String prefix = content.substring(0,content.indexOf(":"));
                        java.lang.String namespaceUri = xmlStreamReader.getNamespaceContext().getNamespaceURI(prefix);
                        return AttribDtl_type0.Factory.fromString(content,namespaceUri);
                    } else {
        ...
        */
        public static AttribDtl_type0 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AttribDtl_type0 object =
                new AttribDtl_type0();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"AttribDtl_type0".equals(type)){
                                ...
                                return (AttribDtl_type0)com.tibco.www.schemas.vnm_project_uat.shared_resources.schema.xml.xsd.crbt.giftsong_xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
