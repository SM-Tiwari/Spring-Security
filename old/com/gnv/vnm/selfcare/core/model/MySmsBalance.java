 ...
 *
 */
public class MySmsBalance implements Serializable {
	...
	public MySmsBalance(int totalValue, int consumedValue, int availableValue, List<Balance> balanceList) {
	...
	public String toString() {
		...
		builder.append("MySmsBalance [totalValue=");
