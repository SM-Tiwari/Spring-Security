 ...
 * 2017-01-11T17:01:08.034+07:00
 * Generated source version: 2.3.8
 * 
 */
@WebServiceClient(name = "ScfMobileSoap", 
                  wsdlLocation = "classpath:wsdl/UPCCProvisioning.wsdl",
...
public class ScfMobileSoap extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("wsdl/UPCCProvisioning.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ScfMobileSoap.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "classpath:upcc/UPCCProvisioning.wsdl");
        }
        WSDL_LOCATION = url;
    }
