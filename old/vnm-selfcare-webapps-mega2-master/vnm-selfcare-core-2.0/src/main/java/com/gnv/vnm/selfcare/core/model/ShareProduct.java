...
public class ShareProduct implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3866452611383455113L;
	...
	public ShareProduct(Integer id, String code, String name, String description, String details, DataStatus status,
			double price) {
		this.id = id;
		this.code = code;
		this.name = name;
	...
	public int hashCode() {
		...
		result = prime * result + ((defaultBanner == null) ? 0 : defaultBanner.hashCode());
		result = prime * result + ((defaultImage == null) ? 0 : defaultImage.hashCode());
		result = prime * result + ((description == null) ? 0 : description.hashCode());
		result = prime * result + ((details == null) ? 0 : details.hashCode());
		result = prime * result + ((howToRegister == null) ? 0 : howToRegister.hashCode());
		result = prime * result + ((howToUnregister == null) ? 0 : howToUnregister.hashCode());
		...
		result = prime * result + (purchaseEnabled ? 1231 : 1237);
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ShareProduct other = (ShareProduct) obj;
		if (alias == null) {
			if (other.alias != null)
				return false;
		...
		if (defaultBanner == null) {
			if (other.defaultBanner != null)
				return false;
		} else if (!defaultBanner.equals(other.defaultBanner))
			return false;
		...
		if (details == null) {
			...
			return false;
		if (howToRegister == null) {
			if (other.howToRegister != null)
				return false;
		} else if (!howToRegister.equals(other.howToRegister))
			return false;
		if (howToUnregister == null) {
			if (other.howToUnregister != null)
				return false;
		} else if (!howToUnregister.equals(other.howToUnregister))
			return false;
		if (id == null) {
			if (other.id != null)
				return false;
		...
		if (productGroupName == null) {
			...
			return false;
		if (purchaseEnabled != other.purchaseEnabled)
			return false;
		if (quota == null) {
			if (other.quota != null)
				return false;
