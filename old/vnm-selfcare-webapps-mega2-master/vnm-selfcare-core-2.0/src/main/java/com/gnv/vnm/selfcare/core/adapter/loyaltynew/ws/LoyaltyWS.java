...
public class LoyaltyWS extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/workSpace/VietApi/vnm-selfcare-webapps-mega2-master/resources/wsdl/LoyaltyWSFatty.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(LoyaltyWS.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/D:/workSpace/VietApi/vnm-selfcare-webapps-mega2-master/resources/wsdl/LoyaltyWSFatty.wsdl");
        }
        WSDL_LOCATION = url;
    }
