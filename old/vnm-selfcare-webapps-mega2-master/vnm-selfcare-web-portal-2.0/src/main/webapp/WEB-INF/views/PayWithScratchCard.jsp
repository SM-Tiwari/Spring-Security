...
<head>
	...
	<title>My Vietnamobile - Pay with Scratch Card</title>
				...
				<div id="scratchCardContent">
					<form:form id="topupFrm" method="POST" modelAttribute="voucherTopUp">
						...
						<div class="form-group">
							<label><spring:message code="label.Postpaid.OutstandingBilling" text="Outstanding Billing"/></label>
							<p><span class="wowText"><fmt:formatNumber value="${outstandingBalance}" pattern="#,##0"/>đ</span></p><br/>
						</div>
						<div class="form-group">
		...
		if (validInputs()){
			if ($("#mynumber").val() != $("#msisdn").val()){
				BootstrapDialog.confirm({
			        title: '',
			        message: '<spring:message code="Message.PayWithScratchCard.Confirmation" text="Are you sure you want to pay for"/> ' + $("#msisdn").val() + '?',
