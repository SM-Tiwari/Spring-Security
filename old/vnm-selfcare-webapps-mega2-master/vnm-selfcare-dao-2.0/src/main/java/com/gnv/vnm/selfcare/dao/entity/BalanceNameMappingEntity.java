...
@Entity
@Table(name = "balance_name_mappings", uniqueConstraints = { @UniqueConstraint(columnNames = "rtbs_name") })
@SequenceGenerator(name = "balance_map_seq", sequenceName = "balance_map_seq", allocationSize = 1)
public class BalanceNameMappingEntity extends BaseEntity {

	private static final long serialVersionUID = 1116656682276969664L;
